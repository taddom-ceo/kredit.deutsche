...
export default function StepConfirmation() {
  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-20 flex flex-col items-center text-center gap-6">
      ...
      <div className="w-full rounded-[24px] border border-border bg-surface p-6 sm:p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.55)] ring-1 ring-white/5 flex flex-col gap-4 text-left">
